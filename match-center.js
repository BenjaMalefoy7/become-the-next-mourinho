const BTM_MATCH_CENTER_ENTRYPOINT_VERSION = "0.24";
(function () {
  ...
  function player(career, id) {
    return Array.isArray(career?.players) ? career.players.find(p => p.id === id) || null : null;
  }
  ...
  refreshUI = function refreshUIV024MatchCenter() {
